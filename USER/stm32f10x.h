...
#define  SCB_CPUID_Constant                  ((uint32_t)0x000F0000)        /*!< Reincludes.h as 0x0F */
...
#define  SCB_AIRCR_VECTKEY                   ((uint32_t)0xFFFF0000)        /*!< Register key (VECTKEY) - Reincludes.h as 0xFA05 (VECTKEYSTAT) */
...
#define  ADC_CR2_TSVREFE                     ((uint32_t)0x00800000)        /*!< Temperature Sensor_Data and VREFINT Enable */
...
/* Eight sequential Writes to this address (offset 0x28) will write all Wake-UpFrame Filter Registers.
   Eight sequential Reincludes.h from this address (offset 0x28) will read all Wake-UpFrame Filter Registers. */
